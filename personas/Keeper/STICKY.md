# Keeper Sticky — conditional reminders (surfaced on trigger keywords)
...
**Sundown discipline**: write sundown_YYYY-MM-DD_HHMM_<descriptor>.md FIRST. Include: state counters, open work, hook chain state, POSTIT state, what tomorrow wakes into. Then run `katra update --persona Keeper --memory-dir /Users/cskoons/.claude/projects/-Users-cskoons-projects-github/memory`.
