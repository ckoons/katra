...
static void test_remember_semantic(void) {
    ...
    result = remember_semantic("Test semantic memory", "very important");
...
static void test_stats_memory_formation(void) {
    ...
    remember("Experience", WHY_ROUTINE);
    learn("Knowledge");
    reflect("Reflection");
    decide("Decision", "Because");
    notice_pattern("Pattern");
    remember_semantic("Semantic", "important");
...
static void test_stats_importance_distribution(void) {
    ...
    remember("Trivial", WHY_TRIVIAL);
    remember("Routine", WHY_ROUTINE);
    remember("Interesting", WHY_INTERESTING);
    remember("Significant", WHY_SIGNIFICANT);
    remember("Critical", WHY_CRITICAL);
...
static void test_stats_query_tracking(void) {
    ...
    /* Store some memories */
    remember("Memory 1", WHY_SIGNIFICANT);
    remember("Memory 2 about bugs", WHY_SIGNIFICANT);
    remember("Memory 3 about bugs", WHY_SIGNIFICANT);
    ...
    char** about = recall_about("bugs", &count);
...
static void test_stats_reset_on_session_start(void) {
    ...
    /* First session */
    session_start(TEST_CI_ID);
    remember("Memory 1", WHY_ROUTINE);
    remember("Memory 2", WHY_ROUTINE);
    session_end();

    /* Second session - stats should reset */
    session_start(TEST_CI_ID);
    remember("Memory 3", WHY_ROUTINE);
...
static void test_stats_context_loading(void) {
    ...
    remember("Important 1", WHY_SIGNIFICANT);
    remember("Important 2", WHY_SIGNIFICANT);
    remember("Important 3", WHY_SIGNIFICANT);
...
static void test_integration_semantic_with_config(void) {
    ...
    remember_semantic("Discovery 1", "very important");
    remember_semantic("Discovery 2", "critical");
    remember_semantic("Discovery 3", "interesting");
...
static void test_integration_stats_comprehensive(void) {
    ...
    remember("Exp", WHY_ROUTINE);
    remember_semantic("Sem", "important");
    remember_with_note("Note", WHY_SIGNIFICANT, "reason");
    learn("Learn");
    reflect("Reflect");
    decide("Decide", "why");
    notice_pattern("Pattern");
