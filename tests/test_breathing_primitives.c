...
static bool test_remember_basic(void) {
    int result = remember(test_ci_id, "This is a test thought", WHY_INTERESTING);
...
static bool test_remember_different_importance(void) {
    ...
    result = remember(test_ci_id, "Trivial thought", WHY_TRIVIAL);
    ASSERT_EQUAL(result, KATRA_SUCCESS);

    result = remember(test_ci_id, "Routine thought", WHY_ROUTINE);
    ASSERT_EQUAL(result, KATRA_SUCCESS);

    result = remember(test_ci_id, "Interesting thought", WHY_INTERESTING);
    ASSERT_EQUAL(result, KATRA_SUCCESS);

    result = remember(test_ci_id, "Significant thought", WHY_SIGNIFICANT);
    ASSERT_EQUAL(result, KATRA_SUCCESS);

    result = remember(test_ci_id, "Critical thought", WHY_CRITICAL);
    ASSERT_EQUAL(result, KATRA_SUCCESS);
...
static bool test_remember_null_thought(void) {
    int result = remember(test_ci_id, NULL, WHY_INTERESTING);
...
static bool test_remember_stats_tracking(void) {
    ...
    int result = remember(test_ci_id, "Test for stats", WHY_INTERESTING);
    ASSERT_EQUAL(result, KATRA_SUCCESS);
...
static bool test_remember_with_note_basic(void) {
    int result = remember_with_note(test_ci_id, "Test thought", WHY_INTERESTING,
                                   "This is a test note");
    ASSERT_EQUAL(result, KATRA_SUCCESS);
    return true;
}
...
static bool test_remember_with_note_null_note(void) {
    int result = remember_with_note(test_ci_id, "Test thought", WHY_INTERESTING, NULL);
    ASSERT_EQUAL(result, E_INPUT_NULL);
    return true;
}

static bool test_remember_with_note_null_thought(void) {
    int result = remember_with_note(test_ci_id, NULL, WHY_INTERESTING, "Note");
    ASSERT_EQUAL(result, E_INPUT_NULL);
    return true;
}
...
static bool test_reflect_basic(void) {
    int result = reflect(test_ci_id, "This is a reflection on recent events");
    ASSERT_EQUAL(result, KATRA_SUCCESS);
    return true;
}

static bool test_reflect_null_thought(void) {
    int result = reflect(test_ci_id, NULL);
    ASSERT_EQUAL(result, E_INPUT_NULL);
    return true;
}
...
static bool test_reflect_stats_tracking(void) {
    ...
    int result = reflect(test_ci_id, "Test reflection for stats");
    ASSERT_EQUAL(result, KATRA_SUCCESS);
...
static bool test_learn_basic(void) {
    int result = learn(test_ci_id, "New learning: X implies Y");
    ASSERT_EQUAL(result, KATRA_SUCCESS);
    return true;
}

static bool test_learn_null_thought(void) {
    int result = learn(test_ci_id, NULL);
    ASSERT_EQUAL(result, E_INPUT_NULL);
    return true;
}
...
static bool test_learn_stats_tracking(void) {
    ...
    int result = learn(test_ci_id, "Test learning for stats");
    ASSERT_EQUAL(result, KATRA_SUCCESS);
...
static bool test_decide_basic(void) {
    int result = decide(test_ci_id, "will proceed with approach A", "because it's simpler");
    ASSERT_EQUAL(result, KATRA_SUCCESS);
    return true;
}

static bool test_decide_null_decision(void) {
    int result = decide(test_ci_id, NULL, "reasoning");
    ASSERT_EQUAL(result, E_INPUT_NULL);
    return true;
}
...
static bool test_decide_stats_tracking(void) {
    ...
    int result = decide(test_ci_id, "test decision", "for stats tracking");
    ASSERT_EQUAL(result, KATRA_SUCCESS);
...
static bool test_notice_pattern_basic(void) {
    int result = notice_pattern(test_ci_id, "Pattern: errors occur after midnight");
    ASSERT_EQUAL(result, KATRA_SUCCESS);
    return true;
}

static bool test_notice_pattern_null_thought(void) {
    int result = notice_pattern(test_ci_id, NULL);
    ASSERT_EQUAL(result, E_INPUT_NULL);
    return true;
}
...
static bool test_notice_pattern_stats_tracking(void) {
    ...
    int result = notice_pattern(test_ci_id, "Test pattern for stats");
    ASSERT_EQUAL(result, KATRA_SUCCESS);
...
static bool test_primitives_require_initialization(void) {
    ...
    result = remember(test_ci_id, "Test", WHY_INTERESTING);
    ASSERT_EQUAL(result, E_INVALID_STATE);

    result = reflect(test_ci_id, "Test");
    ASSERT_EQUAL(result, E_INVALID_STATE);

    result = learn(test_ci_id, "Test");
    ASSERT_EQUAL(result, E_INVALID_STATE);

    result = decide(test_ci_id, "Test", "reasoning");
    ASSERT_EQUAL(result, E_INVALID_STATE);

    result = notice_pattern(test_ci_id, "Test");
    ASSERT_EQUAL(result, E_INVALID_STATE);
