...
static void test_sequential_edges(void) {
    ...
    /* Store first memory */
    result = remember_semantic("First memory in sequence", "interesting");
    if (result != KATRA_SUCCESS) {
        breathe_cleanup();
    ...
    result = remember_semantic("Second memory in sequence", "interesting");
    if (result != KATRA_SUCCESS) {
        breathe_cleanup();
...
static void test_similar_edges(void) {
    ...
    result = remember_semantic("The dog ran through the park", "interesting");
    if (result != KATRA_SUCCESS) {
        breathe_cleanup();
        TEST_FAIL("Failed to store first memory");
    }
    ...
    result = remember_semantic("The puppy played in the park", "interesting");
    if (result != KATRA_SUCCESS) {
        breathe_cleanup();
        TEST_FAIL("Failed to store second memory");
    }
    ...
    result = remember_semantic("Quantum physics is fascinating", "interesting");
    if (result != KATRA_SUCCESS) {
        breathe_cleanup();
...
static void test_disable_auto_edges(void) {
    ...
    /* Store memories */
    result = remember_semantic("First memory", "interesting");
    if (result != KATRA_SUCCESS) {
        breathe_cleanup();
        TEST_FAIL("Failed to store first memory");
    }

    result = remember_semantic("Second memory", "interesting");
    if (result != KATRA_SUCCESS) {
        breathe_cleanup();
        TEST_FAIL("Failed to store second memory");
    }
...
static void test_edge_traversal(void) {
    ...
    result = remember_semantic("Memory A", "interesting");
    if (result != KATRA_SUCCESS) {
        breathe_cleanup();
    ...
    result = remember_semantic("Memory B", "interesting");
    if (result != KATRA_SUCCESS) {
        breathe_cleanup();
    ...
    result = remember_semantic("Memory C", "interesting");
    if (result != KATRA_SUCCESS) {
        breathe_cleanup();
    ...
    size_t count = 0;
    char** recent_ids = recent_thoughts(3, &count);
...
static void test_similarity_threshold(void) {
    ...
    result = remember_semantic("Machine learning uses algorithms", "interesting");
    if (result != KATRA_SUCCESS) {
        breathe_cleanup();
        TEST_FAIL("Failed to store first memory");
    }
    ...
    result = remember_semantic("Artificial intelligence processes data", "interesting");
    if (result != KATRA_SUCCESS) {
        breathe_cleanup();
        TEST_FAIL("Failed to store second memory");
    }
