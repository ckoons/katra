...
/* Exported for mcp_tools_interstitial.c */
pthread_mutex_t mcp_wm_lock = PTHREAD_MUTEX_INITIALIZER;
...
/* ============================================================================
 * ACCESSOR FUNCTIONS FOR mcp_tools_interstitial.c
 * ============================================================================ */
...
/**
 * Get working memory from context - exported for mcp_tools_interstitial.c
 */
working_memory_t* mcp_ctx_get_working_memory(void* ctx) {
    if (!ctx) return NULL;
    return ((ci_cognitive_context_t*)ctx)->working_memory;
}

/**
 * Get interstitial processor from context - exported for mcp_tools_interstitial.c
 */
interstitial_processor_t* mcp_ctx_get_interstitial(void* ctx) {
    if (!ctx) return NULL;
    return ((ci_cognitive_context_t*)ctx)->interstitial;
}
...
/* Interstitial tools moved to mcp_tools_interstitial.c */
